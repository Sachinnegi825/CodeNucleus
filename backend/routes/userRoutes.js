...
import { createAgency, createCoder, getAuditLogs, getCoders, getAgencies, toggleUserStatus, updateCoderPassword, getGlobalCoders } from '../controllers/userController.js';
...
router.get('/global-coders', protect, authorizeRoles('superadmin'), getGlobalCoders);
